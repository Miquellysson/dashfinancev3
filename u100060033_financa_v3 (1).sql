...
(21, 'Mk teste', 'mike@gmail.com', '(82) 99922-2020', '2025-10-10', 'sdasasdasdasdasddasda', '2025-10-10 21:52:51', '2025-10-10 21:52:51') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `name`=VALUES(`name`), `email`=VALUES(`email`), `phone`=VALUES(`phone`), `entry_date`=VALUES(`entry_date`), `notes`=VALUES(`notes`), `created_at`=VALUES(`created_at`), `updated_at`=VALUES(`updated_at`);
...
(11, 1, 5, 'email', '2025-10-15 00:23:51', 'TENTEI LIGAR\n', '2025-10-15', 'POREM NADA\n', 0, 1, '2025-10-15 03:23:51') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `card_id`=VALUES(`card_id`), `payment_id`=VALUES(`payment_id`), `contact_type`=VALUES(`contact_type`), `contacted_at`=VALUES(`contacted_at`), `client_response`=VALUES(`client_response`), `expected_payment_at`=VALUES(`expected_payment_at`), `notes`=VALUES(`notes`), `is_reminder`=VALUES(`is_reminder`), `created_by`=VALUES(`created_by`), `created_at`=VALUES(`created_at`);
...
(13, 1, 5, 'em_cobranca', 'em_cobranca', 'auto_contact', 'Movido automaticamente após registrar contato.', 1, '2025-10-15 03:23:51') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `card_id`=VALUES(`card_id`), `payment_id`=VALUES(`payment_id`), `from_status`=VALUES(`from_status`), `to_status`=VALUES(`to_status`), `reason_code`=VALUES(`reason_code`), `notes`=VALUES(`notes`), `created_by`=VALUES(`created_by`), `created_at`=VALUES(`created_at`);
...
(5, 'weekly', '2025-10-13', '2025-10-18', 10.00, '2025-10-10 21:55:47', '2025-10-10 21:55:47') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `period_type`=VALUES(`period_type`), `period_start`=VALUES(`period_start`), `period_end`=VALUES(`period_end`), `target_value`=VALUES(`target_value`), `created_at`=VALUES(`created_at`), `updated_at`=VALUES(`updated_at`);
...
(5, 17, 16, 'one_time', 'receita', 'devedor', 'Site', NULL, 12.00, 'BRL', '2025-10-13', NULL, 13, '2025-10-15 03:22:35', '2025-10-15 03:23:51') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `project_id`=VALUES(`project_id`), `client_id`=VALUES(`client_id`), `kind`=VALUES(`kind`), `transaction_type`=VALUES(`transaction_type`), `description`=VALUES(`description`), `category`=VALUES(`category`), `notes`=VALUES(`notes`), `amount`=VALUES(`amount`), `currency`=VALUES(`currency`), `due_date`=VALUES(`due_date`), `paid_at`=VALUES(`paid_at`), `status_id`=VALUES(`status_id`), `created_at`=VALUES(`created_at`), `updated_at`=VALUES(`updated_at`);
...
(19, 2, 'Voice', '2025-10-10 14:14:25', 'Rifa + IA', 'ativo', 767.00, 4, NULL, NULL, 0, NULL, NULL, NULL, '2025-09-25 13:51:25', '2025-10-11 09:48:17', 'Desenvolvimento Web', 'Insatisfeito', 73000.00, 'Pendente', 0.00, 73000.00, '', NULL, NULL) ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `client_id`=VALUES(`client_id`), `nome_cliente`=VALUES(`nome_cliente`), `data_entrada`=VALUES(`data_entrada`), `name`=VALUES(`name`), `status`=VALUES(`status`), `project_value`=VALUES(`project_value`), `status_id`=VALUES(`status_id`), `due_date`=VALUES(`due_date`), `paid_at`=VALUES(`paid_at`), `recurrence_active`=VALUES(`recurrence_active`), `recurrence_value`=VALUES(`recurrence_value`), `recurrence_frequency`=VALUES(`recurrence_frequency`), `recurrence_next_date`=VALUES(`recurrence_next_date`), `created_at`=VALUES(`created_at`), `updated_at`=VALUES(`updated_at`), `tipo_servico`=VALUES(`tipo_servico`), `status_satisfacao`=VALUES(`status_satisfacao`), `valor_projeto`=VALUES(`valor_projeto`), `status_pagamento`=VALUES(`status_pagamento`), `valor_pago`=VALUES(`valor_pago`), `valor_pendente`=VALUES(`valor_pendente`), `observacoes`=VALUES(`observacoes`), `usuario_responsavel_id`=VALUES(`usuario_responsavel_id`), `deleted_at`=VALUES(`deleted_at`);
...
(14, 'Perdido', '#6B7280', 14, '2025-10-15 03:18:16', '2025-10-15 03:18:16') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `name`=VALUES(`name`), `color_hex`=VALUES(`color_hex`), `sort_order`=VALUES(`sort_order`), `created_at`=VALUES(`created_at`), `updated_at`=VALUES(`updated_at`);
...
(4, 1, 'create', '{\"user_id\":3}', '170.84.159.212', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:143.0) Gecko/20100101 Firefox/143.0', '2025-10-11 21:03:06') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `usuario_id`=VALUES(`usuario_id`), `acao`=VALUES(`acao`), `detalhes`=VALUES(`detalhes`), `ip`=VALUES(`ip`), `user_agent`=VALUES(`user_agent`), `created_at`=VALUES(`created_at`);
